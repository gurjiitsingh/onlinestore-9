...
//console.log(productName, productPrice, productCategory,productId)
...
/>
<input type='hidden' name='productId' value="kljsdklsjflsjlflslkflk" />

          {/* <SubmitButton>Update Product</SubmitButton> */}
          <Button value="THis is but">Update Product</Button>
        </form>
      </Form>
    </div>
  );
